...
/**
 * <p>
 * Java class for SellerLookupRequest complex type.
 * 
 * <p>
...
@XmlType(name = "SellerLookupRequest", propOrder = { "responseGroup",
        "sellerId", "feedbackPage" })
public class SellerLookupRequest {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the sellerId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
