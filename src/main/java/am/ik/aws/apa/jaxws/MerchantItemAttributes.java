...
@XmlType(name = "", propOrder = { "actor", "address", "amazonMaximumAge",
        "amazonMinimumAge", "apertureModes", "artist", "aspectRatio",
        "assemblyInstructions", "assemblyRequired", "audienceRating",
        "audioFormat", "author", "backFinding", "bandMaterialType",
        "batteriesIncluded", "batteriesRequired", "batteries",
        "batteryDescription", "batteryType", "bezelMaterialType", "binding",
        "brand", "calendarType", "cameraManualFeatures", "caseDiameter",
        "caseMaterialType", "caseThickness", "caseType", "catalogNumber",
        "cdrwDescription", "chainType", "claspType", "clothingSize", "color",
        "compatibility", "computerHardwareType", "computerPlatform",
        "connectivity", "continuousShootingSpeed", "country",
        "countryOfOrigin", "cpuManufacturer", "cpuSpeed", "cpuType", "creator",
        "cuisine", "customizable", "delayBetweenShots", "deliveryOption",
        "department", "description", "deweyDecimalNumber", "dialColor",
        "dialWindowMaterialType", "digitalZoom", "director", "displaySize",
        "drumSetPieceQuantity", "dvdLayers", "dvdrwDescription", "dvdSides",
        "dpci", "ean", "edition", "esrbAgeRating",
        "externalDisplaySupportDescription", "fabricType", "faxNumber",
        "feature", "firstIssueLeadTime", "floppyDiskDriveDescription",
        "format", "fixedShippingCharge", "gemType", "graphicsCardInterface",
        "graphicsDescription", "graphicsMemorySize", "guitarAttribute",
        "guitarBridgeSystem", "guitarPickThickness",
        "guitarPickupConfiguration", "hardDiskCount", "hardDiskSize",
        ...
        "includedSoftware", "includesMp3Player", "indications", "ingredients",
        "ingredientsSetElement", "instrumentKey", "isAutographed", "isbn",
        "isEmailNotifyAvailable", "isFragile", "isLabCreated", "isMemorabilia",
        "isoEquivalent", "issuesPerYear", "itemDimensions",
        "keyboardDescription", "label", "languages", "legalDisclaimer",
        "lineVoltage", "listPrice", "macroFocusRange", "magazineType",
        "malletHardness", "manufacturer",
        "manufacturerLaborWarrantyDescription", "manufacturerMaximumAge",
        "manufacturerMinimumAge", "manufacturerPartsWarrantyDescription",
        "materialType", "maximumAperture", "maximumColorDepth",
        ...
        "memorySlotsAvailable", "metalStamp", "metalType",
        "miniMovieDescription", "minimumAdvertisedPrice", "minimumFocalLength",
        "minimumShutterSpeed", "model", "modelYear", "modemDescription",
        "monitorSize", "monitorViewableDiagonalSize", "mouseDescription",
        "mpn", "musicalStyle", "nativeResolution", "neighborhood",
        ...
        "numberOfTracks", "opticalZoom", "originalReleaseDate",
        "outputWattage", "packageDimensions", "pearlLustre",
        "pearlMinimumColor", "pearlShape", "pearlStringingMethod",
        "pearlSurfaceBlemishes", "pearlType", "pearlUniformity", "phoneNumber",
        "photoFlashType", "pictureFormat", "platform", "priceRating",
        "processorCount", "productGroup", "promotionalTag",
        "poBoxShippingExcluded", "publicationDate", "publisher",
        "purchasingChannel", "readingLevel", "recorderTrackCount",
        "regionCode", "regionOfOrigin", "releaseDate", "returnMethod",
        "removableMemory", "resolutionModes", "returnPolicy", "ringSize",
        "safetyWarning", "salesRestriction", "secondaryCacheSize",
        "settingType", "size", "sku", "soldInStores", "sizePerPearl",
        "skillLevel", "soundCardDescription", "speakerCount",
        "speakerDescription", "specialFeatures", "stoneClarity", "stoneColor",
        "stoneCut", "stoneShape", "stoneWeight", "studio",
        "subscriptionLength", "supportedImageType", "systemBusSpeed",
        "systemMemorySizeMax", "systemMemorySize", "systemMemoryType",
        "tellingPageIndicator", "theatricalReleaseDate", "title",
        "totalDiamondWeight", "totalExternalBaysFree", "totalFirewirePorts",
        "totalGemWeight", "totalInternalBaysFree", "totalMetalWeight",
        "totalNTSCPALPorts", "totalParallelPorts", "totalPCCardSlots",
        "totalPCISlotsFree", "totalSerialPorts", "totalSVideoOutPorts",
        "totalUSB2Ports", "totalUSBPorts", "totalVGAOutPorts", "upc",
        "variationDenomination", "variationDescription", "vendorRebate",
        "warranty", "watchMovementType", "websiteBuyability",
...
public class MerchantItemAttributes {
     ...
     * 
     * @return possible object is {@link MerchantItemAttributes.ItemDimensions }
     * 
     */
     ...
     * 
     * @return possible object is {@link MerchantItemAttributes.Languages }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link MerchantItemAttributes.Languages }
     * 
     */
    ...
    public void setPackageDimensions(
            MerchantItemAttributes.PackageDimensions value) {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the purchasingChannel property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
     ...
     * 
     * @return possible object is {@link MerchantItemAttributes.VendorRebate }
     * 
     */
     ...
     * 
     * @param value
     *            allowed object is {@link MerchantItemAttributes.VendorRebate }
     * 
     */
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "type", "startDate", "endDate" })
