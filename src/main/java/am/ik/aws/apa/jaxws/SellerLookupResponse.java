...
@XmlType(name = "", propOrder = { "operationRequest", "sellers" })
...
public class SellerLookupResponse {
     ...
     * <CODE>set</CODE> method for the sellers property.
     * 
     * <p>
     ...
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list {@link Sellers }
     * 
     * 
     */
