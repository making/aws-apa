...
/**
 * <p>
 * Java class for TransactionLookupRequest complex type.
 * 
 * <p>
...
@XmlType(name = "TransactionLookupRequest", propOrder = { "responseGroup",
        "transactionId" })
public class TransactionLookupRequest {
     ...
     * snapshot. Therefore any modification you make to the returned list will
     * be present inside the JAXB object. This is why there is not a
     * <CODE>set</CODE> method for the transactionId property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * 
